...
namespace TemporaryDataLayer.EntityConfigurations.Users
{
    public class ApplicationUserEntityConfiguration : IEntityTypeConfiguration<ApplicationUser>
    {
        public void Configure(EntityTypeBuilder<ApplicationUser> builder)
        {
            ...
            // This is very weird; also changed qualification level
            // (to match existing schema)
            //builder.HasOne<AbstractClassifier>()
            //    .WithMany()
            //    .HasForeignKey(model => model.QualificationLevelId);
        }
    }
}
