...
namespace TemporaryDataLayer.Migrations
{
    ...
    [Migration("20220923064652_CommitteeSuggestion1")]
    partial class CommitteeSuggestion1
    {
            ...
            modelBuilder.Entity("TemporaryDataLayer.ApplicationUser", b =>
                {
                    ...
                    b.HasOne("TemporaryDataLayer.QualificationLevel")
                        .WithMany("ApplicationUsers")
                        .HasForeignKey("QualificationLevelId")
                        .HasConstraintName("FK_dbo.ApplicationUser_dbo.QualificationLevels_QualificationLevelId");
